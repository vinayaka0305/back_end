...
const { register, login } = require('../controllers/userController'); // Importing the register and login functions from the user controller
const isLoggedIn = require('../middleware/isLoggedIn'); // Importing the isLoggedIn middleware
